...
const demos = [
  { name: 'Demo Kira', category: 'STARTER', desc: 'Herbal brand landing page', url: '#', thumb: '/demo/kira.jpg' },
  { name: 'Lumina Hotel', category: 'BUSINESS', desc: 'Hotel company profile', url: '#', thumb: '/demo/lumina.jpg' },
  { name: 'Demo Forma', category: 'BUSINESS', desc: 'Architecture studio', url: '#', thumb: '/demo/forma.jpg' },
  { name: 'Graha V1', category: 'STARTER', desc: 'Property landing page', url: '#', thumb: '/demo/graha.jpg' },
  { name: 'Rinjani Open Trip', category: 'STORE', desc: 'Open trip booking', url: '#', thumb: '/demo/rinjani.jpg' },
];
